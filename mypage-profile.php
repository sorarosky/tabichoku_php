...
<div class="contents-wrap mypage mypage-profile">
    ...
    <main class="main dashboard">
      ...
      <div class="main-container">
        ...
        <form action="" class="form h-adr">
          ...
          <!-- SOF .form-box -->
          <div class="form-box form-box-headline">
          ...
          <!-- SOF .form-box -->
          <div class="form-box form-box-sm-margin">

            <div class="form-header">
              <p class="form-title">プロフィール写真</p>
            </div>

            <div class="form-content form-content-flex form-content-flex-no-wrap form-content-flex-aligh-top">
              <div class="form-content-item">
                <div class="form-content-item-img-preview">
                  <img class="js-img-preview" src="assets/img/mypage-profile-no-image.svg" alt="">
                </div>
              </div>
              <div class="form-content-item form-content-item-no-shrink">
                <p>最大アップロードサイズ : 2MB</p>
          ...
          <div class="form-box">
            ...
            <div class="form-content form-content-flex">
              <div class="form-content-item">
                <input class="js-input-birthdate input-birthdate" type="text" name="" id="" placeholder="1990/00/00">
              </div>
              <div class="form-content-item">
                <p>年齢：<span class="js-age"></span>歳</p>
              </div>
            </div>
          ...
          <div class="form-box">
            ...
            <div class="form-content form-content-flex">
              ...
              <div class="form-content-item">
                <input type="text" name="" id="" placeholder="1234567" class="js-zip-personal">
              </div>
              <div class="form-content-item">
            ...
            <div class="form-content form-content-flex form-content-flex-even-sp">
              <div class="form-content-item">
          ...
          <!-- SOF .form-box -->
          <div class="form-box form-box-narrow-margin-top">
            <div class="form-header">
              <p class="form-title">勤務先名</p>
            </div>
            <div class="form-content">
              <div class="form-content-item">
