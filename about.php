...
<div class="contents-wrap">
  <main class="main about">
    <section class="section-content page-head">
        <div class="name">たびチョクとは</div>
        <nav class="page-navi">
          <ul class="links">
            <li class="link current"><a href="">たびチョクとは</a></li>
            <li class="link"><a href="">会社概要</a></li>
            <li class="link"><a href="">パートナー募集</a></li>
    ...
    <section class="section-content about">
      <div class="inner">
        ...
        <div class="copy">お客様と世界を直接結ぶオンライン旅行直販サイト</div>
        <div class="text">
          旅行は自らの課題を発見し、解決する能力を育み、自分の夢や理想を実現できる力を持っています。<br>
          旅行が一番輝くのはお客様の未来が映し出されたとき。そのアイデア段階から現地パートナーが共創出来たらなんとすばらしいことでしょうか！<br>
          「郷に入れば郷に従え」と言われるように、現地に精通するプロフェッショナル達が持ち寄った旅コンテンツは、産地直送ならではユニークでお客様への愛に溢れた秀逸な作品ばかりです。もちろん、ホテルやレストランなどの基本コンテンツも品揃え満載ですが、たびチョクは全て、お客様からのリクエストがあってはじめて現地確認を行いますので、お客様の細かな希望を伝えられますし、お客様と対話を重ねながら思い通りの手配に近づけられますように全力でお客様をサポート致します。<br>
          デジタル時代の中、ポチっとボタン一つで予約済になるものとオンラインで遠くの人とも気軽に相談できる旅行直販サイトを上手に使い分けて、新しい旅行スタイルを始めてみませんか？
        </div>
        <div class="img">
        <img src="/assets/img/about01.svg" alt="">
        </div>
      </div>
    </section>
    <section class="section-content important">
      <div class="inner">
        <div class="head">たびチョクが大切にしていること</div>
        <div class="row">
          <div class="col col-12 col-md-6">
            <ul>
              <li>日本語メッセージの送受信</li>
              <li>日本円による旅行代金精算</li>
              <li>お客様が現地パートナーにオーダーメード注文できる</li>
              <li>お客様と現地パートナーのメールによる個別対応</li>
              <li>社会課題を解決し、自己成長を育むコンテンツの質</li>
              <li>情報発信と問合せの一体化</li>
            </ul>
          </div>
          <div class="col col-12 col-md-6">
            <ul>
              <li>日本語による現地連絡体制</li>
              <li>お客様が現地パートナーを自主選択できる</li>
              <li>お客様と現地パートナーのダイレクトオペレーション</li>
              <li>バリエーションがあり、充実したコンテンツの量</li>
              <li>きれいで見やすく心に刺さるコンテンツの伝播力</li>
              <li>早くて探しやすい検索性の確保</li>
            </ul>
          </div>
        </div>
      </div>
